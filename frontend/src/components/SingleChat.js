...
const SingleChat = ({ fetchAgain, setFetchAgain }) => {
  ...
  useEffect(() => {
    ...
    const handleMessage = (newMessageRecieved) => {
      // if the incoming message is for a different chat, add to notifications
      if (
        !selectedChatCompare ||
        ...
        // append message using functional update to avoid stale closure
  ...
  return (
    <>
      {selectedChat ? (
          ...
          >
            ...
            >
              ...
              <Input
                ...
                color="#E6EEF6"
                _placeholder={{ color: "rgba(230,238,246,0.45)" }}
        ...
        <Box d="flex" alignItems="center" justifyContent="center" h="100%" borderRadius="0">
